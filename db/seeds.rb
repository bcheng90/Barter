...
emails = ["notika314@sohotmail.com", "ben@sohotmail.com", "ryan@sohotmail.com", "lauren@sohotmail.com", "steph@sohotmail.com", "angel@sohotmail.com", "eveanandi@sohotmail.com", "tracy@sohotmail.com", "kevin@sohotmail.com", "hoa@sohotmail.com", "sam@sohotmail.com", "kiran@sohotmail.com", "ryanB@sohotmail.com", "malcolm@sohotmail.com"]
...
# User 4 Talents
Talent.create([{title: "Destiny - Gaming", type: "Computers & Electronics", experience: "Novice", description: "Games are fun", user_id: 4}, {title: "Physics Tutoring", type: "Education & Careers", experience: "Intermediate", description: "Things go up and things go down.", user_id: 4}, {title: "Boxing", type: "Sports", experience: "Novice", user_id: 4}, {title: "Chemistry Tutoring", type: "Education & Careers", experience: "Novice", description: "I'll show you how to mix everything.", user_id: 4}])
# User 5 Talents
...
# User 13 Talents
Talent.create([{title: "How to Make Friends and Influence People", type: "Education & Careers", experience: "Expert", description: "Making friends made easy", user_id: 13}, {title: "Singing", type: "Art & Music", experience: "Novice", description: "Let my voice soothe you so you can one day soothe others.", user_id: 13}, {title: "Physics Tutoring", type: "Education & Careers", experience: "Intermediate", description: "Gravity means nothing until you learn from me", user_id: 13}, {title: "Destiny", type: "Computers & Electronics", experience: "Intermediate", description: "This was meant to be. Come learn from me.", user_id: 13}])
# User 14 Talents
