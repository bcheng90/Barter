...
Talent.create([{title: "Hip-hop dance", type: "artMusic", experience: "novice", user_id: 1}, {title: "Swing dance", type: "artMusic", experience: "novice", description: "Been dancing for 50 years but 25 of them were before I was born.", user_id: 1}, {title: "Baking Bread", type: "food", experience: "novice", description: "Baking bread beautifully all day, every day.", user_id: 1}, {title: "Ruby - Coding", type: "compEle", experience: "novice", description: "My fingers become the code itself.", user_id: 1}])
# User 2 Talents
Talent.create([{title: "Ruby on Rails - Coding", type: "compEle", experience: "expert", description: "I can type rails faster than a train can travel", user_id: 2}, {title: "Minesweeper", type: "compEle", experience: "expert", description: "I had once decided to become a professional minesweeper. The danger turned me away.", user_id: 2}, {title: "Learn Chinese", type: "educareer", experience: "expert", description: "I can speak Mandarin but it just sounds very Americanized.", user_id: 2}])
# User 3 Talents
Talent.create([{title: "Baseball", type: "sport", experience: "expert", description: "Home runs are my 2nd favorite hit.", user_id: 3}, {title: "PHP - Coding", type: "compEle", experience: "intermediate", description: "Ruby is my forte. But PHP is my forte's forte.", user_id: 3}, {title: "Piano", type: "artMusic", experience: "expert", description: "Watch my fingers flow before your eyes.", user_id: 3}])
# User 4 Talents
Talent.create([{title: "Destiny - Gaming", type: "compEle", experience: "novice", description: "Games are fun", user_id: 4}, {title: "Physics Tutoring", type: "educareer", experience: "intermediate", description: "Things go up and things go down.", user_id: 4}, {title: "Boxing", type: "sport", experience: "novice", user_id: 4}, {title: "Chemistry Tutoring", type: "educareer", experience: "novice", description: "I'll show you how to mix everything.", user_id: 4}])
# User 5 Talents
Talent.create([{title: "Snowboarding", type: "sport", experience: "expert", description: "Hitting the slopes is the fastesy way to learn", user_id: 5}, {title: "Sewing", type: "artMusic", experience: "expert", description: "I can sew buttons like you wouldn't believe.", user_id: 5}, {title: "Pencil Sketching", type: "artMusic", experience: "intermediate", description: "Graphite is my best friend, and it'll be yours soon too!", user_id: 5}, {title: "Fix your doors", type: "homeImp", experience: "novice", description: "Watch my doormaking come to life", user_id: 5}, {title: "Cardio", type: "nuFit", experience: "intermediate", description: "Let's get that heart rate up!", user_id: 5}])
# User 6 Talents
Talent.create([{title: "Ballet", type: "artMusic", experience: "expert", description: "Watch as my toes lift me higher.", user_id: 6}, {title: "Singing", type: "artMusic", experience: "novice", description: "Vocal cords are the best way to sooth the soul", user_id: 6}, {title: "Table Tennis", type: "sport", experience: "intermediate", description: "The ball may seem small, but playing brings you into a whole new world", user_id: 6}, {title: "Korean Dishes", type: "food", experience: "intermediate", description: "I'll teach you how to cook galbi, bulgolgi, and even bibimbap", user_id: 6}])
# User 7 Talents
Talent.create([{title: "Presenting Dishes", type: "food", experience: "intermediate", description: "Fancy dishes made simple", user_id: 7}, {title: "World of Warcraft - Gaming", type: "compEle", experience: "novice", description: "Let me WOW you.", user_id: 7}, {title: "Baking Cakes", type: "food", experience: "expert", description: "The cake won't be a lie.", user_id: 7}])
# User 8 Talents
Talent.create([{title: "Cardio", type: "nuFit", experience: "intermediate", description: "Run like the wind... and me next to you.", user_id: 8}, {title: "Basketball", type: "sport", experience: "intermediate", description: "Ball is life.",  user_id: 8}, {title: "Italian Dishes", type: "food", experience: "novice", description: "Who doesn't love pizza?", user_id: 8}, {title: "Ruby on Rails - Coding", type: "compEle", experience: "expert", description: "Been doing rails for years. Minus years and plus months.", user_id: 8}, {title: "Flute", type: "artMusic", experience: "intermediate", description: "I played a lot in HS.", user_id: 8} ])
# User 9 Talents
Talent.create([{title: "How to Make Friends and Influence People", type: "educareer", experience: "expert", description: "This book is my life. And I will make it yours", user_id:9 }, {title: "Bodybuilding", type: "nuFit", experience: "expert", description: "I pick things up and put them down. Now you will be able to as well!", user_id: 9}, {title: "Saxophone", type: "artMusic", experience: "intermediate", description: "Ever see the saxophone man? I'm him reincarnated.", user_id: 9}])
# User 10 Talents
Talent.create([{title: "Vietnamese Dishes", type: "food", experience: "expert", description: "What the pho?", user_id: 10}, {title: "Career Advice and Guidance", type: "educareer", experience: "novice", description: "Let me guide your life.", user_id: 10}, {title: "Cooking Halal Food", type: "food", experience: "expert", description: "Enough to combat the Halal Guys", user_id: 10}, {title: "Making Desserts", type: "food", experience: "novice", description: "The sweetest of all tastes", user_id: 10}, {title: "Minesweeper", type: "compEle", experience: "expert", description: "By the end of the session, you'll be completing medium in under a minute. Blindfolded.", user_id: 10}])
# User 11 Talents
Talent.create([{title: "Grand Theft Auto", type: "compEle", experience: "expert", description: "The greatest thief in the world.", user_id: 11}, {title: "Chinese Dishes", type: "food", experience: "intermediate", description: "Making the best dishes that you'll never see in Chinese Take-out restaurants", user_id: 11}, {title: "Math Tutoring", type: "educareer", experience: "intermediate", description: "2+2 ain't got nothin' on you.", user_id: 11}])
# User 12 Talents
Talent.create([{title: "Baseball", type: "sport", experience: "expert", description: "Babe Ruth was my 2nd best student.", user_id: 12}, {title: "Billards - Pool", type: "sport", experience: "novice", description: "I can win a game on the first hit.", user_id: 12}, {title: "Soccer", type: "sport", experience: "expert", description: "Watch as my legs juggle faster than you can juggle with your hands", user_id: 12}, {title: "Fix your sink", type: "homeImp", experience: "intermediate", description: "How else will you brush your teeth?", user_id: 12}, {title: "Fix your heater", type: "homeImp", experience: "expert", description: "How else will you stay warm?", user_id: 12}, {title: "Become bob the builder", type: "homeImp", experience: "intermediate", description: "How else will you fix everything?", user_id:12}])
# User 13 Talents
Talent.create([{title: "How to Make Friends and Influence People", type: "educareer", experience: "expert", description: "Making friends made easy", user_id: 13}, {title: "Singing", type: "artMusic", experience: "novice", description: "Let my voice soothe you so you can one day soothe others.", user_id: 13}, {title: "Physics Tutoring", type: "educareer", experience: "intermediate", description: "Gravity means nothing until you learn from me", user_id: 13}, {title: "Destiny", type: "compEle", experience: "intermediate", description: "This was meant to be. Come learn from me.", user_id: 13}])
# User 14 Talents
Talent.create([{title: "Hip-hop dance", type: "artMusic", experience: "novice", description: "Feel the beats. Become the sound. Yeah.", user_id: 14}, {title: "Sewing", type: "artMusic", experience: "expert", description: "In one day, you'll sew faster than a sewing machine.", user_id: 14}, {title: "Boxing", type: "sport", experience: "expert", description: "You'll be throwing 1-2s all day.", user_id: 14}, {title: "Minesweeper", type: "compEle", experience: "intermediate", description: "Because it's a great hobby to know.", user_id: 14}])
